...
function ResetPasswordCaptain() {
    ...
    async function handleReset(data , event) {
        ...
        try{
            ...
            const response = await apiConnector("POST" , captainEndpoints.Captain_ResetPassword_api , formdata);
...
export default ResetPasswordCaptain