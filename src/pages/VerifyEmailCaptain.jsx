...
function VerifyEmail() {
    ...
    const {captain , setCaptain , setToken} = useContext(UserData);
    const {email} = captain;
    ...
    async function HandleSubmit(event) {
        ...
        try{
            ...
            const response = await apiConnector("POST" , captainEndpoints.Captain_Signup_api , signupData);
    ...
    async function otpHandler() {
        ...
        try{
            ...
            const response = await apiConnector("POST" , captainEndpoints.Captain_SendOtp_api, {email})
